...
import { distance, multiply, normalize, subtract, add } from "../../shared/math";
import { Mesh, Position, Target, Velocity } from "../../shared/traits";
import { ECSSystemHook, type ECSSystem } from "../../types";
    ...
    (world, delta: number) => {
      ...
      for (const entity of entities) {
        ...
        if (position) {
          ...
          // snap to ground
          raycaster.set(new Vector3(position.x, position.y + 2, position.z), new Vector3(0, -1, 0));
